...
import { handleValidCreditCard, handleNumberCreditCard, handleCvvCreditCard } from '../../controller/modal';
...
export default function createModalCreditCard() {
  ...
  creditCardNumberInput.addEventListener('keypress', (e) => handleNumberCreditCard(e));
  ...
  creditCardCvvInput.addEventListener('keypress', (e) => handleCvvCreditCard(e));
  ...
  creditCardValidInput.addEventListener('keypress', (e) => handleValidCreditCard(e));
